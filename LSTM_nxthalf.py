...
df1 = pd.read_csv('/home/ProjB2125/Desktop/Project/Winsorised/0.1per_wins.csv')
df1['date'] = pd.to_datetime(df1['date'])
df1['SN_winsorized']=pd.to_numeric(df1['SN_winsorized'], errors='coerce')
df1 = df1.rename(columns={'SN_winsorized': 'merged_SSN'})


start_date1='1755-02-01'
end_date1='2019-12-01'

filtered_df1 = df1[(df1['date'] >= start_date1) & (df1['date'] <= end_date1)]

DF1 = filtered_df1[['date','merged_SSN']]

df2 = pd.read_csv('/home/ProjB2125/Desktop/Project/PLOTSandCSV_LSTM/SC25_half_pred.csv')
df2['Date'] = pd.to_datetime(df2['Date'])
df2['mean']=pd.to_numeric(df2['mean'], errors='coerce')
df2 = df2.rename(columns={'Date': 'date'})
df2 = df2.rename(columns={'mean': 'merged_SSN'})


start_date2='2020-01-01'
end_date2='2024-12-01'

filtered_df2 = df2[(df2['date'] >= start_date2) & (df2['date'] <= end_date2)]

DF2 = filtered_df2[['date','merged_SSN']]
DF = pd.concat([DF1, DF2], ignore_index=True)



DF['merged_SSN']=pd.to_numeric(DF['merged_SSN'], errors='coerce')

sn=DF['merged_SSN'].values
...
def plt_ssn_forecast(DF, full_series, future_dates, future_forecast):
...
figure_save_path = "/home/ProjB2125/Desktop/Project/LSTM_nxthalf100/figures/"
csv_save_path = "/home/ProjB2125/Desktop/Project/LSTM_nxthalf100/csvs/"
metrics_save_path = "/home/ProjB2125/Desktop/Project/LSTM_nxthalf100/"
...
for i in range(100):
	...
	full_series = DF['merged_SSN'].astype(float).values
	...
	fig = plt_ssn_forecast(DF, full_series, future_dates, future_forecast)
